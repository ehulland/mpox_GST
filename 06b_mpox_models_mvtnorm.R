...
get_betas<-function(model_fit, ndraws){
  ...
  vcov = vcov(model_fit)
  betas_simulated = mvtnorm::rmvnorm(ndraws, betas, vcov)
...
jpeg(paste0(dir,'/figures/univar_df_dichotomous_fullimputation_grouped_OR_mvtnorm.jpeg'), height=700, width=1000)
...
jpeg(paste0(dir,'/figures/multivar01_df_dichotomous_fullimputation_grouped_OR_mvtnorm.jpeg'), height=700, width=1000)
...
jpeg(paste0(dir,'/figures/univar_df_continuous_fullimputation_grouped_mvtnorm.jpeg'), height=700, width=1000)
...
jpeg(paste0(dir,'/figures/multivar01_df_continuous_fullimputation_grouped_mvtnorm.jpeg'), height=700, width=1000)
