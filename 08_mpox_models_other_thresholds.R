...
##### 
#### FULL DATA IMPUTATION, 188 observations; CONTINUOUS OUTCOME
#####
...
jpeg(paste0(dir,'/figures/multivar_df_continuous_fullimputation_grouped_NOTHRESH.jpeg'), height=700, width=1000)
