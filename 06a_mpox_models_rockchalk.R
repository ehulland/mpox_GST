...
jpeg(paste0(dir,'/figures/univar_df_dichotomous_fullimputation_grouped_OR_rockchalk.jpeg'), height=700, width=1000)
...
jpeg(paste0(dir,'/figures/multivar01_df_dichotomous_fullimputation_grouped_OR_rockchalk.jpeg'), height=700, width=1000)
...
jpeg(paste0(dir,'/figures/multivar01_df_continuous_fullimputation_grouped_rockchalk.jpeg'), height=700, width=1000)
